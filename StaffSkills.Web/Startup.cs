...
using StaffSkills.Domain.Repository;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<StaffSkillsContext>(options => options.UseSqlServer(Configuration.GetConnectionString("StaffSkillsContext")))
                .AddScoped<IContextFactory, DatabaseFactory>()
